...
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 1: "+$settings.projectFile+"\r\n")
...
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 2: "+$settings.sourceAppFolder+"\r\n")

// Configure the application
$settings.buildName:="serverApp"
$settings.destinationFolder:=Folder:C1567(fk desktop folder:K87:19).folder("buildApp/Server")
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 3: "+$settings.destinationFolder+"\r\n")
...
End if 
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 4: "+$settings.windowsClientArchive+"\r\n")
