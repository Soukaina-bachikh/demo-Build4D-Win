...
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 1: "+String:C10($settings.projectFile)+"\r\n")
...
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 2: "+String:C10($settings.sourceAppFolder)+"\r\n")

// Configure the application
$settings.buildName:="serverApp"
$settings.destinationFolder:=Folder:C1567(fk desktop folder:K87:19).folder("buildApp/Server")
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 3: "+String:C10($settings.destinationFolder)+"\r\n")
...
End if 
LOG EVENT:C667(Into system standard outputs:K38:9; "🖥️ inside server code 4: "+String:C10($settings.windowsClientArchive)+"\r\n")
